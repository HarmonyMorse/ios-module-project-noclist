...
func numberOfCompromisedAgents(agents: [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) -> Int {
    var number = 0
    for agent in agents {
...
print(numberOfCompromisedAgents(agents: agents))
//: ## Step 5
...
print(findCleanAgents(agents: agents))
//: ## Step 7
...
func lowMidHigh(agents : [(coverName: String, realName: String, accessLevel: Int, compromised: Bool)]) {
    var low = 0
    var mid = 0
    var high = 0
    for agent in agents {
    ...
    print("There are", low, "low level agents")
    print("There are", mid, "medium level agents")
    print("There are", high, "high level agents")
}
//: ## Step 10
//: Call the above function and check its output in the console.
lowMidHigh(agents: agents)
//: ## Step 11 (Optional)
